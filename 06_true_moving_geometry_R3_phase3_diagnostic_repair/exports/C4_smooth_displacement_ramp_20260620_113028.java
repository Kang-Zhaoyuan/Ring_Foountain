/*
 * C4_smooth_displacement_ramp_20260620_113028.java
 */

import com.comsol.model.*;
import com.comsol.model.util.*;

/** Model exported on Jun 20 2026, 11:33 by COMSOL 6.4.0.293. */
public class C4_smooth_displacement_ramp_20260620_113028 {

  public static Model run() {
    Model model = ModelUtil.create("Model");

    model
         .modelPath("D:\\_COMSOL_FILE_SAVE_\\COMSOL_Ring_Fountain\\06_true_moving_geometry_R3_phase3_diagnostic_repair\\models");

    model.label("true_moving_ring_C4_smooth_displacement_ramp_20260620_113028");
    ...
    model.param().set("z_ring0", "-2[mm]");
    model.param().set("z0", "0[mm]");
    model.param().set("eps_ls", "1[mm]");
    model.param().set("Vring", "1e-3[m/s]");
    ...
    model.param().set("t_ramp", "0.002[s]");

    model.component("comp1").physics("ale").feature("move_ring")
         .set("dx", new String[]{"0", "-Vring*(if(t<t_ramp,t-t_ramp/pi*sin(pi*t/t_ramp),t))"});
