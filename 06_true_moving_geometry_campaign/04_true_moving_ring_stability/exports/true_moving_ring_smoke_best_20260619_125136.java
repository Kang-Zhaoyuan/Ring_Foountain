/*
 * true_moving_ring_smoke_best_20260619_125136.java
 */

import com.comsol.model.*;
import com.comsol.model.util.*;

/** Model exported on Jun 19 2026, 12:53 by COMSOL 6.4.0.293. */
public class true_moving_ring_smoke_best_20260619_125136 {

  public static Model run() {
    Model model = ModelUtil.create("Model");

    model
         .modelPath("D:\\_COMSOL_FILE_SAVE_\\COMSOL_Ring_Fountain\\06_true_moving_geometry_campaign\\04_true_moving_ring_stability\\models");

    model.label("true_moving_ring_S1_20260619_125136");
    ...
    model.param().set("Vring", "1e-4[m/s]");
    ...
    model.result().numerical("gev1").set("expr", "z-Z");
    model.result().numerical("gev1").set("unit", "m");
    model.result().numerical("gev1").set("data", "dset1");
    model.result().numerical().remove("gev1");
    model.result().numerical().create("eva1", "Eval");
    model.result().numerical("eva1").set("expr", "z-Z");
